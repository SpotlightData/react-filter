...
var MasterFilter = function (_React$Component) {
  ...
  function MasterFilter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MasterFilter.__proto__ || Object.getPrototypeOf(MasterFilter)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return function (newState) {
        _this.props.filters[id].state = newState;
        _this.props.onRefilter(_this.props.filters);
      };
...
exports.pipe = exports.MasterFilter = undefined;

var _MasterFilter = require('./MasterFilter');

var _MasterFilter2 = _interopRequireDefault(_MasterFilter);
...
exports.MasterFilter = _MasterFilter2.default;
